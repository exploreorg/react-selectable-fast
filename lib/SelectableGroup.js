...
var SelectableGroup = (function(_Component) {
  ...
  function SelectableGroup(props) {
    ...
    _this.selectItems = function(selectboxBounds) {
      ...
      _this.props.additionalSelections({
        selecting: _this.selectingItems,
        selected: _this.selectedItems,
        items: _this.registry.values()
      })
    }
...
SelectableGroup.propTypes = {
   ...
   */
  additionalSelections: _propTypes.func,
